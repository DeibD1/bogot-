...
import { tarea, tramo, usuario } from '../db/schema'
import { NUMERO_TRAMO_APROBACION, TOTAL_TRAMOS, type Rol } from '../../shared/dominio'
import type { SesionUsuario } from '../../shared/ipc'
import { aprobarOferta } from './aprobacion'
import { sumarDiasHabiles } from './dias-habiles'
import { promedio } from './indicadores'
import { obtenerIndicadores } from './indicadores-consultas'
